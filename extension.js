...
let SimpleMessage = GObject.registerClass({
    ...
    _init() {
        ...
        this._settings.connect('changed::command', this._updateMessage.bind(this));
    ...
    _updateMessage() {
        // Read the message from the target file
        let [, message] = GLib.file_get_contents(`${GLib.get_home_dir()}/.config/bin/target`);
        this.messageBox.set_text(message.toString());
    }
